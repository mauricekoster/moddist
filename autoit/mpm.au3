...
#Region ### START Koda GUI section ### Form=mpm_mainwindow.kxf
	...
	$lst_modules = GUICtrlCreateListView("Component naam|Ge�nstalleerd?|Beschrijving|URL", 8, 48, 417, 233)
...
Local $arr
	...
	If $arr[2] = "Ja" Then
		$ret = MsgBox( 4 + 32 + 256, $msgbox_title, "Module al ge�nstalleerd. Wilt u deze opnieuw installeren?" )
		If $ret <> 6 Then
